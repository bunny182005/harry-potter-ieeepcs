...
export default function Round1Page() {
  ...
  useEffect(() => {
    const unsubRoundStatus = subscribeToRoundStatus("round1", (result) => {
      if (result.success) {
    ...
    const unsubContent = subscribeToContent("round1", (result) => {
      if (result.success) {
  ...
  return (
    ...
    >
      <div className="min-h-screen flex flex-col">
        ...
        {/* Grid with the new InfoBox components */}
        <div className="grid grid-cols-2 grid-rows-2 w-full p-8 gap-8 pb-16">
            
            {/* ✅ Goal Box is now using the InfoBox component */}
            <InfoBox 
            ...
            {/* ✅ Challenges Box is now using the InfoBox component */}
            <InfoBox 
